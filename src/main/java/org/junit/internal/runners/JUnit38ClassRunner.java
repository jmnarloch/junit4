...
public class JUnit38ClassRunner extends Runner implements Filterable, Orderable {
    private static final class OldTestClassAdaptingListener implements
        ...
        public void addError(Test test, Throwable e) {
            notifier.fireTestFailure(asDescription(test));
        }
        ...
        private Description asDescription(Test test) {
            ...
            // all other possibilities are suboptimal
            Description description = Description.createSuiteDescription(test
            .getClass());
            int n = test.countTestCases();
            for (int i = 0; i < n; i++) {
                description.addChild(Description.createSuiteDescription(
                test.testAt(i).getClass()).toString());
            }
            return description;
        }
