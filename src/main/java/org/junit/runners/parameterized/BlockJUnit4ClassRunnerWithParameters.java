...
public class BlockJUnit4ClassRunnerWithParameters extends
    ...
    private Object createTestUsingFieldInjection() throws Exception {
        ...
        for (FrameworkField each : annotatedFieldsByParameter) {
            ...
            try {
                ...
                + ": Test class cannot access the parameter '"
                + parameters[index] + "'", e);
                ...
                + ", found: " + parameters[index].getClass().getName());
            }
        }
        ...
        if (getInjectionType() == InjectionType.FIELD) {
            ...
            for (FrameworkField each : annotatedFieldsByParameter) {
                ...
                if (index < 0 || index > annotatedFieldsByParameter.size() - 1) {
                    errors.add(new Exception("Invalid @Parameter value: " + index + ". @Parameter fields counted: " + annotatedFieldsByParameter.size() +
                    ". Please use an index between 0 and " + (annotatedFieldsByParameter.size() - 1) + "."));
                } else {
                    usedIndices[index]++;
                }
            }
    ...
    private class RunBeforeParams extends RunBefores {
        ...
        protected void invokeMethod(FrameworkMethod method) throws Throwable {
            method.invokeExplosively(null, parameters);
        }
    }
    ...
    private class RunAfterParams extends RunAfters {
        ...
        @Override
        protected void invokeMethod(FrameworkMethod method) throws Throwable {
            method.invokeExplosively(null, getParametersList(method.getMethod()));
        }
    }
